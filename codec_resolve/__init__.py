"""
HEVC + AV1 + VP9 + VP8 + AVC + Dolby Vision Codec String Resolver & Validator
==============================================================================
zero dependencies · AGPL-3.0

Bidirectional: resolve ↔ decode ↔ validate ↔ hybrid.

Public API:
    resolve()              Content → codec string(s)
    decode_codec_string()  codec string → parsed dict (HEVC, AV1, VP9, VP8, AVC, or DV)
    ...
    decode_avc()           AVC string → parsed dict
